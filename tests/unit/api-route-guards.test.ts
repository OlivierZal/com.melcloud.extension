...
// com.melcloud's routes, not this app's — out of scope here. The guard
// itself is single-sourced in @olivierzal/homey-kit/testing; only the
// table below is this app's.
