...
const config: Config[] = defineConfig([
  ...
  },
  {
    ...
    rules: {
      ...
      '@typescript-eslint/naming-convention': [
        ...
        // ── Properties ───────────────────────────────────────
        // Stricter than com.melcloud: this codebase has no wire-format
        // contracts, so properties stay camelCase.
        {
          format: ['camelCase'],
      ...
      '@typescript-eslint/no-floating-promises': [
        'error',
        { checkThenables: true, ignoreVoid: false },
      ],
      ...
      'unicorn/no-non-function-verb-prefix': ['error', { ignore: [] }],
  ...
  },
  {
    ...
    rules: {
      ...
      // The Homey webview Chromium supports newly-baseline features.
