...
`validate / Validate app`. The composite action is gone since the
configs 6.1.0 / homey-kit 6.2.0 adoption — each reusable reaches its
OWN repository's `.github/actions/setup-node-and-install` through
